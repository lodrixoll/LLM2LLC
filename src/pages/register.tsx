...
const Register = () => {
    return (
        <div
            className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-t from-mint-start to-mint-end text-center py-5"
        ...
        >
            ...
            <div className="container mx-auto text-center flex-grow flex flex-col justify-center px-4">
                ...
                <form className="w-full max-w-md mx-auto bg-white p-8 rounded-lg shadow-lg">
                    ...
                    <div className="mb-8">
                        <button
                            className="bg-mint-500 text-white py-3 px-6 rounded-lg text-lg hover:bg-mint-600 transition duration-300 w-full"
                            type="submit"
                        >
                            Register
                        </button>
                    ...
                    <div className="mb-4">
                        <button
                            className="bg-white text-gray-700 py-3 px-6 rounded-lg text-lg hover:bg-gray-100 transition duration-300 w-full flex items-center justify-center border border-gray-300"
                            type="button"
                        >
